...
var require$$1$1 = require('aws-sdk/lib/maintenance_mode_message');
var require$$0 = require('aws-sdk');
var require$$3 = require('body-parser');
var require$$4 = require('child_process');
var require$$5 = require('cookie-parser');
var require$$6 = require('fs');
var require$$7 = require('path');
var require$$1 = require('request');
...
function requireRequest () {
	...
	function webRequest(opts, done) {
	  ...
	  request$1(opts, (err, response, body) => {
...
function requireSrc () {
	...
	require$$1$1.suppress = true;
	const AWS = require$$0;
	const body_parser = require$$3;
	const child_process = require$$4;
	const cookie_parser = require$$5;
	const fs = require$$6;
